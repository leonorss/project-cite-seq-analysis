...
processCellRangerOutput <- function(patientName, emptyDropsIterations, save, returnSCE) {
  ...
  nCells.original <- ncol(counts(sce))
  ...
  nCells.cleaned <- ncol(counts(sce))
  
  # compute percentage of removed cells
  print("Percentage of removed cells:")
  print(nCells.original)
  print(nCells.cleaned)
  print((nCells.original-nCells.cleaned) / nCells.original * 100)
...
```{r test}
processCellRangerOutput("patient1_HS", 100000, TRUE, FALSE)
```