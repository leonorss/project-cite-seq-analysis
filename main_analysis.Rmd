...
```{r normalization_reduction, results="hide"}
...
```{r cluster_annotation, fig.keep=c(3, 6, 9, 11, 10, 12, 13, 14)}
...
```{r keratinocyte, fig.keep=c(5, 10, 15, 20)}
...
```{r fibroblast, fig.keep=c(5, 10, 15, 20)}
