...
Understanding the heterogeneity of skin cancer cells as well as their cell type composition over disease development are key to find new therapeutic interventions @McFarland2020Aug

-- optionial if we find something. 
...
sce.patient1_HS <- variance_stabilization(sce.patient1_HS, 2000)

sce.patient1_SCC <- variance_stabilization(sce.patient1_SCC, 2000)

sce.patient2_HS <- variance_stabilization(sce.patient2_HS, 2000)

sce.patient2_AK <- variance_stabilization(sce.patient2_AK, 2000)
```
...
sce.patient1_HS <- sc_PCA(sce.patient1_HS, known_markers)
sce.patient1_SCC <- sc_PCA(sce.patient1_SCC, known_markers)
sce.patient2_HS <- sc_PCA(sce.patient2_HS, known_markers)
sce.patient2_AK <- sc_PCA(sce.patient2_AK, known_markers)
