...
TODO : reorganize and put hvg step in the next step (hvg is used for pca)
```{r vst, include=FALSE}
...
genes <- list(
  ...
  # MITOTIC CELL
  mitotic  = c("UBE2C","PCNA", "CDK1", "TOP2A")
)
...
For Patient 1, it seems that their diseased skin (SCC) contains a far higher proportion of lymphocytes, endothelial cells and myleloid cells. Conversely, the proportion of keratinocytes is far lower.

For Patient 2, the diseased skin (AK) cointains
