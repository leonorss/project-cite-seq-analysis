...
celltype_barplot(df.celltypes.patient1, "Patient 1", T, "Proportion of cell types in")
celltype_barplot(df.celltypes.patient2, "Patient 2", T, "Proportion of cell types in")
